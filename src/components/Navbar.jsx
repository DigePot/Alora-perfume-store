  ...
  return (
    <div
      className={`fixed w-full z-50 transition-all duration-300 ${
        isScrolled ? "bg-gray-100/95 backdrop-blur-sm text-gray-800 shadow-md" : "bg-transparent text-white"
      }`}
    >
          ...
          <div className="flex justify-between items-center w-full px-8 py-3">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="relative">
                <FaLock className="cursor-pointer h-5 w-5 text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-110" />
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed top-0 left-0 h-full w-[280px] bg-black/95 backdrop-blur-md text-white border-r border-white/20 transform transition-transform duration-300 ease-in-out ${
